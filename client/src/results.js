...
class Results extends Component {
  ...
  render() {
    ...
    const renderStar = stars.map((x, index) => {
      return <span key={index} className={x} />;
    });
    return (
        ...
        <ul>
          <li className="results-list">
            ...
            <div className="info">
              ...
              <p
                className="currentGoing"
                onMouseOver={e => this.handlePopUp(e)}
                onMouseOut={() => this.hidePopUp()}
              >
                Going? {this.state.going} currently going!
              </p>
              <button className={classes} onClick={this.rsvp} />
            </div>
